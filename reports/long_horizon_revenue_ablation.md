...
|---:|---:|---:|---:|---:|---:|---:|---|---|---:|---:|---|
| 60d | 20435.86 | 19199.67 | 33400.42 | 30397.05 | 10.94% | 10.11% | paired_bootstrap_absolute_error_delta | trained_absolute_error_minus_safe_baseline_absolute_error | 232.8134 to 2328.2964 | 0.019 | safe_baseline_fallback |
...
| Channel/campaign-type mix drift | Detect whether spend share movement supports residual correction at 60/90 days. | Adopted as part of the horizon-specific trained estimate; latest 60-day point-error evidence favors baseline but intervals remain calibrated. |
