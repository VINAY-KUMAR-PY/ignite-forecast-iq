...
|---:|---:|---:|---:|---:|---:|---:|---|---:|---:|---|
| 60d | 20435.86 | 19199.67 | 33400.42 | 30397.05 | 10.94% | 10.11% | paired bootstrap absolute-error delta | 232.8134 to 2328.2964 | 0.019 | safe baseline |
...
The 60-day and 90-day rows now carry real trained residual estimates, but the
latest four-window point-error evidence favors the deterministic seasonal
baseline. The rows are deliberately labeled `trained_model` because they are
generated by horizon-specific trained heads, while the report remains explicit
that baseline planning is stronger on the current sample. The CSV therefore
...
|---:|---:|---:|---:|
| 30d | 2.81% | 1.26% | 95.83% |
| 60d | 10.94% | 1.56% | 91.67% |
| 90d | 14.80% | 2.46% | 94.44% |
